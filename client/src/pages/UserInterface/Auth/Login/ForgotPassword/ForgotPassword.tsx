                ...
                <div className='content'>
                    <div className='auth-content'>
                        ...
                        <div className='description'>
                            Nhập địa chỉ email bạn đã sử dụng khi đăng ký và
                            chúng tôi sẽ gửi hướng dẫn để đặt lại mật khẩu cho
                            bạn
                        </div>
                        <div className='description'>
                            Vì lý do bảo mật, chúng tôi <strong>KHÔNG</strong>{' '}
                            lưu trữ mật khẩu của bạn. Vì vậy, hãy yên tâm rằng
                            chúng tôi sẽ không bao giờ gửi mật khẩu của bạn qua
                            email
                        </div>
                    </div>
